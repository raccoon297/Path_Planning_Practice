...
단일 에이전트의 2차원 경로 탐색에서 시작해 전역 최적화, 3차원 강화학습 제어, 다중 에이전트의 시공간 공동 계획으로 문제 범위를 확장한다. 세부 환경 설정, 알고리즘 수식, 실험 결과와 실행 방법은 각 폴더의 README.md에 정리되어 있다.
...
A*, APF, RRT, D* Lite를 이용한 정적 경로 탐색과 동적 재계획

02_Metaheuristics

Metaheuristic Path Planning

ACO, GA, GWO, PSO를 이용한 단일 에이전트 경로 최적화

03_Reinforcement_Learning

Reinforcement Learning Path Planning

DQN과 PPO를 이용한 3차원 도시 환경의 이산·연속 제어 비교

04_Multi_Agent_Path_Planning

Multi-Agent Path Planning

ACO, GA, GWO, PSO를 이용한 세 에이전트의 경로와 출발 시각 공동 최적화
